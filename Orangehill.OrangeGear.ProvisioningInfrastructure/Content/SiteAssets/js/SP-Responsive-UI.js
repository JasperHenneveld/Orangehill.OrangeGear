    ...
    if (!window.jQuery) {
        ...
        $(function() { // only execute when DOM is fully loaded
            ...
            if (currentScriptUrl != undefined) {
                var currentScriptBaseUrl = currentScriptUrl.substring(0, currentScriptUrl.lastIndexOf("/"));
                currentScriptBaseUrl = currentScriptBaseUrl.substring(0, currentScriptBaseUrl.lastIndexOf("/") + 1);
                addViewport();
                loadCSS(currentScriptBaseUrl + 'css/SP-Responsive-UI.css');
            }
