...
namespace Orangehill.OrangeGear.SPNotificationsWeb
{
    public class RemoteEventReceiverManager
    {
        ...
        public void AssociateRemoteEventsToHostSite(ClientContext clientContext)
        {
            ////Add Push Notification Feature to HostWeb
            ////Not required here, just a demonstration that you
            ////can activate features.
            ...
            if (!rerExists)
            {
                ...
                receiver.EventType = EventReceiverType.ItemCheckedIn;
                ...
                //Add the new event receiver to a list in the host web
                site.EventReceivers.Add(receiver);
                clientContext.ExecuteQuery();
        ...
        public void ItemUpdatedToListEventHandler(ClientContext clientContext, Guid listId, int listItemId)
        {
            try
            {
                ...
                if (file.Level == FileLevel.Published)
                {
                    ...
                    PublishingPage page = PublishingPage.GetPublishingPage(clientContext, item);
